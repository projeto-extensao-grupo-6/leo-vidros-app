...
import { SERVICO_ETAPAS } from "../../../core/constants";
...
const DEFAULT_FORM_DATA = {
    ...
    servicos: [],
    observacoes: "",
    etapa: SERVICO_ETAPAS.AGUARDANDO_ORCAMENTO, // Sempre AGUARDANDO_ORCAMENTO por padrão
    prioridade: "Normal",
};
...
const NovoPedidoServicoModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    const etapasServico = Object.values(SERVICO_ETAPAS);
