...
const EditarPedidoModal = ({ isOpen, onClose, pedido, onSuccess }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            console.log('✅ Pedido atualizado com sucesso! Mostrando modal...');
            ...
            // Aguardar um pouco antes de fechar para o usuário ver o modal
            setTimeout(() => {
                console.log('Fechando modal de edição após timeout...');
