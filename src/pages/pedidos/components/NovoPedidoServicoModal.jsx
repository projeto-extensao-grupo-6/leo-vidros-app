...
const NovoPedidoServicoModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const { cadastrarCliente, salvarServico, buscarClientes, buscarServicos } =
    usePedidoServicoAPI();
  ...
  const calcularValorTotal = () => {
    return formData.servicos.reduce(
      (total, servico) => total + (servico.precoEstimado || 0),
      0,
    );
  };
    ...
    try {
      ...
      const pedidoData = {
        ...
        servico: {
          ...
          descricao:
            formData.servicos.map((s) => s.descricao || s.nome).join("; ") ||
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        <div className="flex flex-col gap-1">
                          ...
                          <input
                            ...
                            value={servico.nome}
                            onChange={(e) =>
                              handleServicoChange(index, "nome", e.target.value)
                            }
                          />
                        </div>
              ...
              <div className="bg-gray-50 rounded-md p-4 border">
                ...
                <div className="flex flex-col gap-3">
                  {formData.servicos.map((servico, index) => (
                    <div
                      key={index}
                      className="border-l-4 border-[#007EA7] pl-4"
                    >
                      ...
                      <p className="text-gray-700 font-medium">
                        R$ {servico.precoEstimado.toFixed(2)}
                      </p>
                    </div>
                  ))}
              ...
              <div className="bg-gray-50 rounded-md p-4 border">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <p>
                    ...
                    <span className="font-medium">{formData.etapa}</span>
                  </p>
                </div>
                {formData.observacoes && (
