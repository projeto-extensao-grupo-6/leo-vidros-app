...
export default function NovaSenha() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 font-[Inter]">
      <Paper
        elevation={3}
        className="rounded-xl shadow-2xl p-10 w-full max-w-md mx-auto"
      >
        <div className="flex flex-col items-center text-center">
          <div className="flex flex-col items-center p-3 text-center gap-3">
            <img
            ...
            <p className="text-gray-800 mb-12 text-lg">
              Defina sua nova senha para começar a utilizar o sistema
            </p>
          </div>
          <form onSubmit={handleSubmit} className="w-full max-w-sm">
            ...
            <div className="mb-10 text-left">
              <Input
                ...
                variant="filled"
                error={
                  confirmaSenha.length > 0 && !passwordsMatch
