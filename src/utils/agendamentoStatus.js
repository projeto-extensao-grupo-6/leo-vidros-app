...
export const getTipoConfig = (tipo) =>
  tipoConfig[tipo] || tipoConfig.SERVICO;

export const statusColors = {
  PENDENTE: { bg: "bg-yellow-100", border: "border-l-yellow-500", text: "text-yellow-700", dot: "bg-yellow-500" },
  CONFIRMADO: { bg: "bg-green-100", border: "border-l-green-500", text: "text-green-700", dot: "bg-green-500" },
  CONCLUIDO: { bg: "bg-blue-100", border: "border-l-blue-500", text: "text-blue-700", dot: "bg-blue-500" },
  CANCELADO: { bg: "bg-red-100", border: "border-l-red-500", text: "text-red-700", dot: "bg-red-500" },
  "EM ANDAMENTO": { bg: "bg-purple-100", border: "border-l-purple-500", text: "text-purple-700", dot: "bg-purple-500" },
};
